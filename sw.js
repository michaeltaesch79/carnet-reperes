...
self.addEventListener("fetch", (event) => {
  ...
  // La page elle-même : le réseau d'abord, pour recevoir les mises à jour ;
  ...
  // Le reste (icônes, polices Google) : le cache d'abord, c'est immuable.
  event.respondWith(
